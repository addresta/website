...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-40 hidden lg:flex items-center justify-center w-12 h-12 rounded-full bg-[#25D366] text-white shadow-lg hover:scale-105 transition-transform lg:bottom-6"
    >
