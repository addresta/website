...
export default function LocationCard({ location }: { location: LocationArea }) {
  return (
    <Link
      ...
      className="group relative block overflow-hidden rounded-[6px] border border-border-card bg-pure-white p-6 transition-all duration-300 hover:-translate-y-1 hover:border-champagne-gold/50 hover:shadow-xl hover:shadow-charcoal/5"
    >
